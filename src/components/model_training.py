...
class ModelTrainer:
    ...
    def train(self, X_train, y_train):
        ...
        try:
            ...
            logging.info(f"Model saved as pickle file in {path}")
    ...
    def evaluate(self, X_test, y_test):
        ...
        with Live("artifacts", save_dvc_exp=True, cache_images=True,monitor_system=True) as live:
...
if __name__=='__main__':
    ...
    logging.info(f"Training Evaluation")
